...
float* leanModelData(FuelCatalogPtr);
...
void copy_maps(float*, float* , int, int);

float Residue_function(float*, float*, int, int);

float error_function(float*, float*, int, int);
