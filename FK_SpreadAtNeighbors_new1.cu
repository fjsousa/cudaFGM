																							...
																							unsigned int*  lockTime)//11
{
	...
	else if(ignCell == timeNow )
	{
		   ...
		   ignNcell > timeNow && spreadMaxMap[cell] >= Smidgen)
		{
			...
			ignTime_sh[thx][thy] = timeNow + DistHV / spreadAny_sh[thx][thy];
		   ...
		   ignNcell > timeNow && spreadMaxMap[cell] >= Smidgen)
		{
			...
			ignTime_sh[thx][thy] = timeNow + DistD / spreadAny_sh[thx][thy];
